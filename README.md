...
2. Complete the following fields.
    - For the Scope field, paste the following: > ZohoBigin.settings.emails.READ,ZohoBigin.send_mail.all.CREATE
    - For the Time Duration field, set it to your preferred duration. **Tip:** 10 minutes is recommended.
    - For the Scope Description, paste the following: > Programmatically send emails from Bigin.
